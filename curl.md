...
# 分段下载
curl -r 0-102400 -o jpg.part1 https://cn.bing.com/th?id=OHR.GlassBridge_EN-CN9756315422_1920x1200.jpg &\
curl -r 102401-204800 -o jpg.part2 https://cn.bing.com/th?id=OHR.GlassBridge_EN-CN9756315422_1920x1200.jpg &\
curl -r 204801- -o jpg.part3 https://cn.bing.com/th?id=OHR.GlassBridge_EN-CN9756315422_1920x1200.jpg
cat jpg.part* > pic.jpg

# 改名下载文件并限制速度
curl -o GlassBridge.jpg --limit-rate 10k https://cn.bing.com/th?id=OHR.GlassBridge_EN-CN9756315422_1920x1200.jpg

# 改名下载文件,限制速度,断点续传
curl -C - -o GlassBridge.jpg --limit-rate 10k https://cn.bing.com/th?id=OHR.GlassBridge_EN-CN9756315422_1920x1200.jpg
...
Post请求
```shell
curl -XPOST ${url} -d '{"title":"a"}'
curl -XPUT ${url} -d '{"title":"a"}'
curl -XDELETE ${url} -d '{"title":"a"}'

curl -XPOST -H 'Content-Type:application/json' -d '{"title":"a"}'
```
